...
export default class Store extends Emitter {
  ...
  constructor(Entity, options = {}) {
    ...
    if (this.constructor === Store) {
      throw new StoreError('Can not instantiate abstract class.', this);
    }

    if (!Entity) {
      throw new StoreError('Entity class is required.', this);
    }

    if ('function' !== typeof Entity) {
      throw new StoreError('The given entity is not a constructor.', this);
    }
    ...
    this.invalid = fn => fn(new StoreError('Invalid entity id property.', this));
  }
